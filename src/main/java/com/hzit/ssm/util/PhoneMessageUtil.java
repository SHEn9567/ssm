...
//        request.putQueryParameter("PhoneNumbers", "18823700274");
//        request.putQueryParameter("SignName", "合众商城");
//        request.putQueryParameter("TemplateCode", "SMS_196652367");
...
//    }
    public boolean sandMassage(String yanZhengMa,String telphone){
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4G5AM1cQvP6fAQMDHYaB";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "tLeSwIuTWICXiF0HeOEFECZVmNuzmk";//你的accessKeySecret，参考本文档步骤2
        ...
        //必填:短信签名-可在短信控制台中找到
        srequest.setSignName("合众商城");
        //必填:短信模板-可在短信控制台中找到
        srequest.setTemplateCode("SMS_169904124");
    ...
    public static void main(String[] args) {
        boolean massage = new PhoneMessageUtil().sandMassage("8888", "18719062559");
